                    ...
                    <div class="card">
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="form-group form-group-label">
                                    <label class="floating-label" for="tunnel_server">隧道节点地址</label>
                                    <input class="form-control maxwidth-edit" id="tunnel_server" name="server" type="text"
                                           value="{$node->tunnel_server}">
                                    <p class="form-control-guide"><i class="material-icons">info</i>订阅地址用
                                    </p>
                                </div>
...
{literal}
                data: {
                    ...
                    tunnel_server: $$getValue('tunnel_server'),
